...
@patch('guess_game.input', return_value='3')
...
@patch('guess_game.input', side_effect=['a', '3'])
@patch('guess_game.print')
...
@patch('guess_game.get_guess_from_user', return_value=4)
@patch('guess_game.generate_number', return_value=4)
...
@patch('guess_game.get_guess_from_user', return_value=3)
@patch('guess_game.generate_number', return_value=4)
...
@patch('guess_game.get_guess_from_user', return_value=BAD_RETURN_CODE)
@patch('guess_game.generate_number', return_value=4)
