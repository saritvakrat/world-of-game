...
@patch('games_utils.score.os.path.exists', return_value=True)
...
@patch('games_utils.score.os.path.exists', return_value=False)
...
@patch('games_utils.score.open', side_effect=IOError("Permission denied"))
