...
@patch('games.currency_roulette_game.requests.get')
...
def test_get_money_interval_valid():
    with patch('games.currency_roulette_game.get_exchange_rate', return_value=3.28):
...
@patch('games.currency_roulette_game.input', return_value='35.0')
...
@patch('games.currency_roulette_game.input', side_effect=['invalid', '40.0'])
@patch('games.currency_roulette_game.print')
...
@patch('games.currency_roulette_game.get_guess_from_user', return_value=35.0)
@patch('games.currency_roulette_game.get_money_interval', return_value=(30.0, 40.0))
@patch('games.currency_roulette_game.print')  # Suppress print during tests
...
@patch('games.currency_roulette_game.get_guess_from_user', return_value=45.0)
@patch('games.currency_roulette_game.get_money_interval', return_value=(30.0, 40.0))
@patch('games.currency_roulette_game.print')  # Suppress print during tests
...
@patch('games.currency_roulette_game.get_money_interval', return_value=None)
@patch('games.currency_roulette_game.print')
